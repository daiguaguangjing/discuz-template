...
<div class="ct2_a wp cl">
	<div class="mn">
		...
		<div class="bm bw0">
			<h1 class="mt">{lang ranklist_activity}</h1>
			<ul class="tb cl">
				<li{if $_GET[view] == 'heats'} class="a"{/if}><a href="misc.php?mod=ranklist&type=activity&view=heats&orderby=$orderby">{lang ranklist_hot}</a></li>
				<li{if $_GET[view] == 'favtimes'} class="a"{/if}><a href="misc.php?mod=ranklist&type=activity&view=favtimes&orderby=$orderby">{lang ranklist_favorite}</a></li>
				<li{if $_GET[view] == 'sharetimes'} class="a"{/if}><a href="misc.php?mod=ranklist&type=activity&view=sharetimes&orderby=$orderby">{lang ranklist_share}</a></li>
			</ul>
