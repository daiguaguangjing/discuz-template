	...
	<div class="xld xlda hasrank">
		...
		<dl class="bbda cl">
			...
			<dd>
				...
				<!--{if $value['unitprice']}--><p>{lang show_unitprice}: <span id="{if $value[uid] == $_G[uid]}show_unitprice{/if}">$value[unitprice]</span><!--{if $value[uid] == $_G[uid]}-->&nbsp;<a href="home.php?mod=spacecp&ac=common&op=modifyunitprice" id="a_modify_unitprice" onclick="showWindow(this.id, this.href, 'get', 0);">({lang modify})</a><!--{/if}--></p><!--{/if}-->
