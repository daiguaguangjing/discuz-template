...
<!--{template common/header}-->
	...
	<div id="ct" class="ct2 wp cl">
		<div class="mn">
			...
			<!--{hook/index_header}-->
			<div id="g_commend" class="zaobm bg0 mb10 cl">
				<div class="bm_h cl">
		...
		<div class="sd">
			...
			<!--{if helper_access::check_module('group')}-->
				<!--{if empty($gid) && empty($sgid)}-->
					<div class="zaobm bg0 mb10 cl">
						<div class="bm_h cl"><h2>{lang create_group_step}</h2></div>
						<div class="bm_c">
			...
			<!--{if $topgrouplist}-->
				<div id="g_top" class="zaobm bg0 mb10 cl">
					<div class="bm_h cl"><h2>{lang group_hot}</h2></div>
					<div class="bm_c">
						<ol class="xl">
