...
<!--{template common/header}-->
	...
	<div id="ct" class="ct2 wp cl">
		<div class="mn">
			...
			<!--{if $action != 'create'}-->
				<!--{if $_G['forum']['banner']}-->
					<div class="zaobm bg0 bm10 cl">
						<div class="p15">
						<img src="$_G[forum][banner]" alt="$_G[forum][name]" style="width:100%;border-radius:5px;" />
						<div class="cl">
							<div class="mb10 cl">
							...
							<div class="cl">
								...
								<div>
									...
									<!--{/if}-->
									{lang credits}: $_G[forum][commoncredits]
									<span class="pipe">|</span>
									{lang group_moderator_title}: 
									<!--{eval $i = 1;}--><!--{loop $groupmanagers $manage}--><!--{if $i <= 0}-->, <!--{/if}--><!--{eval $i--;}--><a href="home.php?mod=space&uid=$manage[uid]" target="_blank" class="xi2">$manage[username]</a><!--{/loop}-->
								</div>
				...
				<div class="zaobm bg0 p15 tb cl{if $action != 'manage'} mbm{/if}">
