...
<!--{if $searchid || (!empty($_GET['adv']) && CURMODULE == 'forum')}-->
	<div class="zaobm bg0 mb15">
		<div class="bm_c">
			<div class="selogo hm mb15"><a href="./" title="$_G['setting']['bbname']">{$_G['style']['searchlogo']}</a></div>
			<table id="scform" cellspacing="0" cellpadding="0" class="mb15" style="margin: 0 auto;">
				<tr>
					<td>
						...
						<table id="scform_form" cellspacing="0" cellpadding="0" style="margin-top:10px;">
							<tr>
	...
	<!--{if $srchtype != 'threadsort'}-->
		<div class="zaobm bg0 mb15">
			...
			<table id="scform" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
				...
				<tr>
					<td>
						<table cellspacing="0" cellpadding="0" id="scform_form" style="margin-top:10px;">
							<tr>
