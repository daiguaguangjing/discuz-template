...
<div id="ct" class="wp cl">
	<div class="mn">
		<div class="bw0">
			<h1 class="mbm bbs mt" style="display:none;"><!--{if !empty($aid)}-->{lang article_edit}<!--{else}-->{lang article_publish}<!--{/if}--></h1>
			...
			<form method="post" autocomplete="off" id="articleform" action="portal.php?mod=portalcp&ac=article{if $_GET[modarticlekey]}&modarticlekey=$_GET[modarticlekey]{/if}" enctype="multipart/form-data">
				...
				<div class="bg0 zaobm p15 mb15">
					...
					<div style="height:400px;"><iframe src="home.php?mod=editor&charset={CHARSET}&allowhtml=1&isportal=1" name="uchome-ifrHtmlEditor" id="uchome-ifrHtmlEditor" scrolling="no" border="0" frameborder="0" style="width:100%;height:100%;position:relative;"></iframe></div>
				</div>

				<!--{hook/portalcp_middle}-->

				<div class="bg0 zaobm mb15 bml">
					<div class="bm_h cl">
