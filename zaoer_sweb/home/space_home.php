...
<!--{if empty($diymode)}-->
	...
	<div id="pt" class="bm cl">
		<div class="z">
			...
			<!--{if $_G[setting][homestyle]}--><a href="home.php">$_G[setting][navs][4][navname]</a><!--{else}-->{lang feed}<!--{/if}-->
		</div>
	</div>
	...
	<div class="bg0 zaobm">
	<div id="ct" class="{if $_G[setting][homestyle]}ct3_a{else}ct2_a{/if} wp cl">
		...
		<div class="sd ptm">
			...
			<!--{if $_G[uid] }-->
				...
				<!--{/if}-->
				<!--{if $_G['setting']['taskstatus'] && !empty($task) && is_array($task)}-->
				<div class="bm">
					<div class="bm_h cl">
						<span class="y">
			...
			<!--{/if}-->
				...
				<!--{if $_G['setting']['ranklist']['membershow'] && $showusers}-->
				<div class="bm">
					<div class="bm_h cl">
						<span class="y">
		...
		<div class="mn ptm pbm">
						...
						<tr>
							<th>
								<div class="avatar mbn cl">
									<a href="home.php?mod=spacecp&ac=avatar" title="{lang memcp_avatar}" id="edit_avt"><!--{if $_G['group']['allowavatarupload']}--><span id="edit_avt_tar">{lang memcp_avatar}</span><!--{/if}--><!--{avatar($_G['uid'], 'big')}--></a>
								</div>
			...
			<!--{else}-->
				...
				<!--{eval
					$space_uid = $space['uid'];
					$_G['home_tpl_spacemenus'][] = "<a href=\"home.php?mod=space&uid=$space_uid&do=home&view=me\">{lang they_feed}</a>";
				}-->
...
<!--{/if}-->
			...
			<!--{elseif $feed_users}-->
				...
				<dl class="bbda cl">
					<dd class="m avt">
						<!--{if $user[uid]}-->
						<a href="home.php?mod=space&uid=$user[uid]" target="_blank" c="1"><!--{avatar($user['uid'], 'big')}--></a>
						<!--{else}-->
