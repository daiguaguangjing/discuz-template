		...
		<div class="c">
			...
			<!--{if $join}-->
				<!--{if $group['dailyprice']}-->
					...
					<tr>
						<td>
							{lang credits_need}{$_G[setting][extcredits][$_G[setting][creditstrans]][title]}</td><td><span id="credits_need"></span> {$_G[setting][extcredits][$_G[setting][creditstrans]][unit]}
